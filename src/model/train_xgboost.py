...
def train_model(X_train, y_train, params):
    try:
        ...
        logging.info("Final XGBoost model trained successfully.")
...
def save_model(model, output_path):
    try:
        ...
        model.save_model(output_path)  # ✅ fixed — uses output_path properly
...
def main():
    try:
        ...
        X_train = load_numpy(
            os.path.join(input_folder, "X_train.npy")
        )

        y_train = load_numpy(
            os.path.join(input_folder, "y_train.npy")
        )
